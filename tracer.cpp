...
int wall_x_texcoord(const float hitx, const float hity, const Textures &tex_walls) {
...
void draw_map(FrameBuffer &fb, const std::vector<Sprite> &sprites, const Textures &tex_walls, const Map &map, const size_t cell_w, const size_t cell_h) {
...
void draw_sprite(FrameBuffer &fb, const Sprite &sprite, const std::vector<float> &depth_buffer, const Player &player, const Textures &tex_sprites) {
...
void render(FrameBuffer &fb, const GameState &gs) {
    ...
    const Textures &tex_walls           = gs.tex_walls;
    const Textures &tex_monst           = gs.tex_monst;
